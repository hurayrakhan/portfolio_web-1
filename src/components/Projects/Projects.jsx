...
const projects = [
  {
    ...
    image: "/images/dishdive.png",
    github: "https://github.com/yourusername/dishdive",
    demo: "https://dishdive.example.com",
  },
  {
    id: 2,
    title: "Buy&Bulk",
    ...
    image: "/images/buyandbulk.png",
    github: "https://github.com/yourusername/buyandbulk",
    demo: "https://buyandbulk.example.com",
  },
];
...
export default function Projects() {
  return (
    <section
      id="projects"
      className="bg-cyan-50 py-16 px-6 md:px-12 lg:px-24 "
    >
      <h1 className="w-4/5 md:w-2/3 text-xl md:text-3xl text-center font-semibold leading-8 md:leading-12 text-gray-800 mx-auto">
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 mt-4">
        {projects.map(({ id, title, description, tech, image, github, demo }) => (
          <div
            key={id}
            className="group relative bg-white rounded-3xl p-6 shadow-md
                       hover:shadow-[0_0_20px_5px_rgba(34,211,238,0.6)]
                       transition duration-500 hover:scale-[1.03] cursor-pointer"
          >
            <img
              src={image}
              alt={title}
